<div class="p-4 flex justify-left">
    ...
    @if($monthlyTargetId)
        <div class="mb-4 p-3 bg-blue-100 text-blue-800 rounded-lg text-sm">
            <strong>Editing Monthly Target ID:</strong> {{ $monthlyTargetId }}<br>
            <strong>Current Values:</strong> Month: {{ $month }}, Year: {{ $year }}, Amount: {{ $target_amount }}, Status: {{ $status }}
        </div>
    @endif

    <form wire:submit.prevent="saveMonthlyTarget" class="w-full" style="width: 60%;">
        <div
            ...
            <div class="space-y-0 border-gray-100 dark:border-gray-800">
                <div class="px-5 py-4 sm:px-6 sm:py-5">
                    <h3 class="text-base font-medium text-gray-800 dark:text-white/90">
                        {{ $monthlyTargetId ? 'Edit Monthly Target' : 'Create Monthly Target' }}
                    </h3>
                </div>
