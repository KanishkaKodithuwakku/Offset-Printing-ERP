...
<div>
        ...
        <div class="rounded-2xl border pl-3 pr-3 border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex flex-col gap-3 px-5 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
                <h3 class="-ml-2 text-lg font-semibold text-gray-800 dark:text-white/90">Other Expenses List</h3>
                ...
                <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-end">
                    ...
                    <!-- Add Expense Button -->
                    <a wire:navigate href="{{ route('other-expense.create') }}"
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        @forelse ($expenses as $expense)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                                ...
                                <td class="px-4 py-2 text-xs text-gray-700 dark:text-white/90">
                                    {{ number_format($expense->price, 2) }} LKR
                                </td>
                                <td class="px-4 py-2 text-xs text-gray-700 dark:text-white/90">
                                ...
                                <td class="px-4 py-2 text-xs">
                                    <div class="flex items-center gap-3">
                                        <a href="{{ route('other-expense.edit', $expense->id) }}" wire:navigate
                        ...
                        @empty
                            <tr>
                                <td colspan="6"
                                    class="px-4 py-4 text-sm text-center text-gray-500 dark:text-white/70">No expenses
                                    found.</td>
                            </tr>
                        @endforelse
                    </tbody>
            ...
            <div class="flex items-center justify-between px-6 py-4 border-t dark:border-gray-800">
                ...
                <div class="flex justify-between pagination">
                    {{ $expenses->links('vendor.pagination.custom-tailwind') }}
                </div>
            </div>
