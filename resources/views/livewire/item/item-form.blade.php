                            ...
                            <div class="flex flex-row px-2.6 flex-1">
                                ...
                                <div class="w-1/2 px-2.5  flex-grow flex-1">
                                    ...
                                    <select wire:model.change="item_type" id="item_type"
                                        class="dark:bg-dark-900 shadow-theme-xs dark:text-gray-200 focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-8 w-full rounded-lg border border-gray-300 bg-transparent px-2 py-1 text-xs text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                                       >
